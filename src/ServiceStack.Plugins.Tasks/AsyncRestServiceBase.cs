...
namespace ServiceStack.ServiceInterface
{
    ...
    public abstract class AsyncRestServiceBase<TRequest>
        : AsyncServiceBase<TRequest>,
        ...
        IRestPatchService<TRequest>
    {
        ...
        /// </summary>
        protected override Task<object> Run(TRequest request)
        {
        ...
        /// </returns>
        public virtual Task<object> OnGet(TRequest request)
        {
        ...
        ///		of 200 to be returned to the client.
        /// </returns>
        public virtual Task<object> OnPut(TRequest request)
        {
            throw new NotImplementedException("This base method should be overridden but not called");
        }
        ...
        ///		of 200 to be returned to the client.
        /// </returns>
        public virtual Task<object> OnPost(TRequest request)
        {
            throw new NotImplementedException("This base method should be overridden but not called");
        }
        ...
        ///		of 200 to be returned to the client.
        /// </returns>
        public virtual Task<object> OnDelete(TRequest request)
        {
            throw new NotImplementedException("This base method should be overridden but not called");
        }
        ...
        ///		of 200 to be returned to the client.
        /// </returns>
        public virtual Task<object> OnPatch(TRequest request)
        {
            throw new NotImplementedException("This base method should be overridden but not called");
        }
