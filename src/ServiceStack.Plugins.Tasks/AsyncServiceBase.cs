...
namespace ServiceStack.ServiceInterface
{
    ...
    {
        private static readonly ILog Log = LogManager.GetLogger(typeof(AsyncServiceBase<>));
        ...
        public AsyncServiceBase<TRequest> SetAppHost(IAppHost appHost) //Allow chaining
        {
        ...
        /// <returns></returns>
        protected abstract Task<object> Run(TRequest request);
