...
{
	public class TaskConverter : IResponseBinder
	{
		...
		public IServiceResult Convert(IHttpRequest httpReq, IHttpResponse httpRes, object responseDto, Action<IServiceResult> callback)
		{
